...
namespace LW2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("Byte: ");
            byte by = Convert.ToByte(Console.ReadLine()); // от 0 до 255 и занимает 1 байт
            Console.Write("Char: ");
            char x = Convert.ToChar(Console.ReadLine()); // одиночный символ в кодировке Unicode и занимает 2 байта
            Console.Write("Decimal: ");
            decimal y = Convert.ToDecimal(Console.ReadLine()); // от ±1.0*10-28 до ±7.9228*1028, может хранить 28 знаков после запятой и занимает 16 байт
            Console.Write("Double: ");
            double z = Convert.ToDouble(Console.ReadLine()); // от ±5.0*10-324 до ±1.7*10308 и занимает 8 байта
            Console.Write("Float: ");
            float p = Convert.ToSingle(Console.ReadLine()); // от -3.4*1038 до 3.4*1038 и занимает 4 байта
            Console.Write("Int: ");
            int i = Convert.ToInt32(Console.ReadLine()); // от -2147483648 до 2147483647 и занимает 4 байта
            Console.Write("Long: ");
            long l = Convert.ToInt64(Console.ReadLine()); // от –9 223 372 036 854 775 808 до 9 223 372 036 854 775 807 и занимает 8 байт
            Console.Write("SByte: ");
            sbyte s = Convert.ToSByte(Console.ReadLine()); // от -128 до 127 и занимает 1 байт
            Console.Write("Short: ");
            short sh = Convert.ToInt16(Console.ReadLine()); // от - 32768 до 32767 и занимает 2 байта
            Console.Write("UInt: ");
            uint ui = Convert.ToUInt32(Console.ReadLine()); //  от 0 до 4294967295 и занимает 4 байта
            Console.Write("ULong: ");
            ulong ul = Convert.ToUInt64(Console.ReadLine()); // от 0 до 18 446 744 073 709 551 615 и занимает 8 байт
            Console.Write("UShort: ");
            ushort ush = Convert.ToUInt16(Console.ReadLine()); // от 0 до 65535 и занимает 2 байта
